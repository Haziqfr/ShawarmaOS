...
CFLAGS := -ffreestanding -fno-builtin -fno-pie -fno-stack-protector -mno-mmx -mno-sse -nostdlib -nostdinc -I include/ -c
CFLAGS +=
ASFLAGS_ELF := -f elf32
...
KERNEL_C_OBJS := $(patsubst $(SRC)/%, $(BUILD_DIR)/%, $(KERNEL_C_SRC:.c=.o))
KERNEL_ASM_OBJS := $(patsubst $(SRC)/%, $(BUILD_DIR)/%, $(KERNEL_ASM_SRC:.asm=.o))
KERNEL_OBJS := $(KERNEL_OBJS) $(KERNEL_ASM_OBJS)
